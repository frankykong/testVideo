...
export default class VideoProcessing extends Component {
  trimVideo() {
    const options = {
      startTime: 0,
      endTime: 15,
    ...
    return (
      <View style={{flex: 1}}>
        <VideoPlayer
          ...
          source={'http://web.art-cloud.com/lesson/2160/media'}
        ...
        <Trimmer
          source={
            'http://web.art-cloud.com/files/course/2017/04-26/61d4fc348c8db_L.jpg'
          }
          height={100}
          width={300}
